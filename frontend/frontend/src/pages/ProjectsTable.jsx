...
const ProjectsTable = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (formData._id) {
        const response=await axios.put(`http://localhost:5000/projects/${formData._id}`, payload, {
          withCredentials: true
        });
        toast.success(response.data.message ||'Project updated successfully', 
        )
      } else {
        const response = await axios.post('http://localhost:5000/projects/add', payload, {
          withCredentials: true
        });
            ...
            <div className="bg-white p-6 rounded-lg w-full max-w-md">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="form-control w-full">
                  <label className="label">
                    <span className="label-text font-bold">Assign Users</span>
                  </label>
